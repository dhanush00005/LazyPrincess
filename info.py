...
API_ID = int(environ['API_ID','13934693'])
API_HASH = environ['API_HASH','c83106d1b09e68264d23287a91c8a2db']
BOT_TOKEN = environ['BOT_TOKEN','6035420237:AAGjwNRTJQixlmzBajcqdEyXM-B8Pnk6jVw']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5906658333').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001981290072').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Thxbots:<Thxbots>@cluster0.5emlsvj.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Thxbots")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'TMP_4U')
